...
public class GUI extends Application {
    ...
    public static void showVisualization(){
        ...
        Scene scene = drawVisualization(stage); //prozatim nevyzita, vyuzije se pri kresleni cest
    }
    ...
    private static void drawTruckRoutes(Scene scene, Truck t){
        /*Polyline pl = new Polyline();
        for(Order o: t.getOrders()){
            pl.getPoints().addAll(o.getSubscriber())
        }*/
    }
}
